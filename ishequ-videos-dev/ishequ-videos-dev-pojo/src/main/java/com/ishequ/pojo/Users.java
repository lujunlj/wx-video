...
public class Users {
     ...
     * 用户名
     */
    @ApiModelProperty(value="用户名", name="username", example="ishequuser", required=true)
    ...
    public Users(String id, String username, String password, String faceImage, String nickname, Integer fansCounts,
			Integer followCounts, Integer receiveLikeCounts,String openid) {
		super();
		this.id = id;
